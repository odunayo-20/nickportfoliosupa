...
export function ProjectEditor({ initialData, id }: ProjectEditorProps) {
    ...
    const defaultValues: ProjectFormValues = {
        ...
        githubUrl: initialData?.github_url || initialData?.githubUrl || "",
        liveUrl: initialData?.live_url || initialData?.liveUrl || "",
        appStoreUrl: initialData?.app_store_url || initialData?.appStoreUrl || "",
