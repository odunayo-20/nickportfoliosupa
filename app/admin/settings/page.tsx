...
<div>
<h2 className="text-3xl font-extrabold tracking-tight text-on-surface">System Preferences</h2>
<p className="text-on-surface-variant mt-2 max-w-lg">Manage your digital architecture and portfolio workspace settings.</p>
</div>
...
<img alt="OG Preview" className="absolute inset-0 w-full h-full object-cover opacity-20 group-hover:opacity-40 transition-opacity" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBjGTq2A5nKROXNwE-q8xO-d6ZbiznvWV6YDQIZ-CItb_F7zsXYl80dqqEIergCBC3sdcAjJFHRe86eDV27p7vcWbvqCIBCc_Z_h5PDrl4AEiXjzUsEy8nAucBpvgDrv503l7Zr0mHpY46m9gEO0NjUpj790KYc3lvCmMibf2zxTNcvjv4RhimBMZE-Rrg_7BX02iiJWW8_0tdkwWo7Rk7LJH-G7TXfxmJwp23fwb0GiRb82MsGZUMBy_rzTaYI5P9P-r3l61icPOc"/>
...
{/* <!-- Footer Meta --> */}
<div className="flex justify-center items-center gap-8 py-8 opacity-40">
<p className="text-[10px] font-bold uppercase tracking-widest">Environment: Production</p>
<div className="h-1 w-1 bg-on-surface rounded-full"></div>
<p className="text-[10px] font-bold uppercase tracking-widest">Last backup: 2h ago</p>
<div className="h-1 w-1 bg-on-surface rounded-full"></div>
<p className="text-[10px] font-bold uppercase tracking-widest">Architect Pro Cloud</p>
</div>
</div>
</>
  )
