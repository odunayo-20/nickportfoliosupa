...
const ProjectDetails = () => {
  return (
    <>
    <header className="pt-20 pb-16 bg-brand-light">
    ...
    <section className="py-24 bg-brand-offwhite">
        <div className="max-w-7xl mx-auto px-6">
            <div className="grid lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-8 space-y-6 reveal text-lg text-brand-muted leading-relaxed">
                    <p>
    ...
    <section className="py-32 bg-brand-green text-white">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white/5 border border-white/10 p-10 rounded-sharp hover:bg-white/10 transition-colors reveal">
    ...
    <section className="py-24 bg-brand-offwhite border-y border-gray-200 border">
        <div className="max-w-7xl mx-auto px-6">
