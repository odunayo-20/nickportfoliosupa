    ...
    >
        <div className="max-w-7xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-10">
                ...
                <motion.div variants={fadeInUp} className="project-card flex flex-col bg-white border border-gray-100 rounded-sharp overflow-hidden hover:shadow-xl transition-shadow reveal">
