            ...
            <header id="home" className="max-w-7xl mx-auto px-6 pt-16 pb-24 grid md:grid-cols-2 gap-12 items-center min-h-[85vh]">
                <div className="reveal">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/projects" aria-label='View My Portfolio' className="cursor-pointer px-8 py-3.5 bg-brand-green text-white font-bold rounded-full flex items-center gap-3 hover:bg-brand-dark transition-all shadow-lg">
                        ...
                        <Link href="/contact" aria-label='Hire Me' className="cursor-pointer px-8 py-3.5 border border-gray-300 font-bold rounded-full hover:border-brand-dark transition-all bg-white">
                            Hire Me
                        </Link>
                    </div>
                </div>
                ...
                <div className="relative flex justify-center items-center h-[500px] reveal">
                    ...
                    <Image src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=800"
                        alt="Nikola"
                        width={800}
                        height={1000}
