            ...
            await sendBrevoEmail({
                ...
                htmlContent: `
                    <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                        ...
                        <p style="font-size: 12px; color: #94a3b8;">You are receiving this because you re-subscribed to my newsletter. If this was a mistake, you can <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/unsubscribe?email=${encodeURIComponent(email)}" style="color: #6366f1; text-decoration: underline;">unsubscribe</a> at any time.</p>
                    </div>
                `
            });
        } catch (e) {
        ...
        await sendBrevoEmail({
            ...
            htmlContent: `
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <hr style="border: none; border-top: 1px solid #e2e8f0; margin: 20px 0;" />
                    <p style="font-size: 12px; color: #94a3b8;">You are receiving this because you subscribed to my newsletter. You can <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/unsubscribe?email=${encodeURIComponent(email)}" style="color: #6366f1; text-decoration: underline;">unsubscribe</a> at any time.</p>
                </div>
            `
        });
    } catch (e) {
